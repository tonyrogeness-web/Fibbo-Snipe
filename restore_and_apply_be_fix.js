...
const targetBlock = `   if(g_FastNPosSymbol > 0) {
...
const correctBlock = `   if(g_FastNPosSymbol > 0) {
      ObjectDelete(0,PANEL_PREFIX+"btn_pause");
      double c_posOpen=0, c_posSL=0, c_posTP=0, c_posProfit=0; long c_posType=0; double c_lot=0; string c_comm=""; ulong c_ticket=0;
      for(int i=PositionsTotal()-1;i>=0;i--){
...
if (content.includes(targetBlock)) {
  ...
  console.log('SUCCESS: Position block and BE calculation restored and fixed!');
} else {
