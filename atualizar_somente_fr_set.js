...
console.log('=== CONFERINDO E BLINDANDO FIBBO_SNIPER_V28.5_H2_SOMENTE_FR.SET ===\n');
...
const filename = "Fibbo_Sniper_v28.5_H2_SOMENTE_FR.set";

targetDirs.forEach(dir => {
  if (fs.existsSync(dir)) {
    fs.writeFileSync(path.join(dir, filename), setFR, 'utf16le');
    console.log(`✔ Salvo e blindado: ${filename} em ${dir}`);
  }
});

console.log('\n=== ARQUIVO SOMENTE_FR.SET 100% GARANTIDO (InpUseFR=true, InpUseFluxo=false) ===');
