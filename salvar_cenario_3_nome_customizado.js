...
console.log('🔄 Salvando o arquivo de parâmetros com o nome "Cenario_3_H2_Maior_Lucro.set"...');
...
// Configuração Cenário 3 H2 (Risco 2.0% / TP2 3.5x / H2 Enum 16386)
const cenario3Content = `InpPerfil=1||0||0||2||N
...
// Salva com nome exato solicitado
writeUtf16LE(path.join(testerDir, 'Cenario_3_H2_Maior_Lucro.set'), cenario3Content);
writeUtf16LE(path.join(localDir, 'Cenario_3_H2_Maior_Lucro.set'), cenario3Content);
writeUtf16LE(path.join(testerDir, 'teste.set'), cenario3Content); // Atualiza teste.set também

console.log('\n🎉 ARQUIVO "Cenario_3_H2_Maior_Lucro.set" SALVO COM SUCESSO!');
