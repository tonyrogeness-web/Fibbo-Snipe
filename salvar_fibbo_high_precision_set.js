...
console.log('🔄 Criando o arquivo .set DUAL ENGINE (FR + FIBO HIGH PRECISION)...');
...
// Configuração Dual Engine: FR + Fibonacci de Alta Precisão (ADX >= 30, Confluência Dupla H1+H4, Pista Limpa, Impulso 2.5x ATR)
...
console.log('🎉 ARQUIVO DE PARÂMETROS DUAL ENGINE CRIDO COM SUCESSO!');
