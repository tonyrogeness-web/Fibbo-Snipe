...
console.log('🔄 Atualizando o arquivo Fibbo_High_Precision_Dual_Engine.set com as travas anti-overtrading...');
...
// Configuração Dual Engine: FR + Fibonacci de Alta Precisão (com Cooldown Anti-Overtrading Ativo)
...
InpUseFiboPullback=true||false||0||true||N
InpFibLevelSell=61.8||0.0||0.000000||0.000000||N
InpFibLevelBuy=18.0||0.0||0.000000||0.000000||N
InpFibMinRange_ATR_Multi=2.5||0.0||0.000000||0.000000||N
InpFib_MagneticZoneATRPct=15.0||0.0||0.000000||0.000000||N
...
const fileName = 'Fibbo_High_Precision_Dual_Engine.set';
writeUtf16LE(path.join(testerDir, fileName), setContent);
writeUtf16LE(path.join(localDir, fileName), setContent);

console.log('🎉 ARQUIVO DE TESTE DUAL ENGINE ATUALIZADO 100%!');
