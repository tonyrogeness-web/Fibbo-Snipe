...
const dirs = [
  ...
  "C:\\Users\\tony\\AppData\\Roaming\\MetaQuotes\\Terminal\\D0E8209F77C8CF37AD8BF550E51FF075\\Tester\\logs",
  "C:\\Users\\tony\\AppData\\Roaming\\MetaQuotes\\Terminal\\59C07D676775FCCF79E223EC24AB0D86\\MQL5\\Logs",
  "C:\\Users\\tony\\AppData\\Roaming\\MetaQuotes\\Terminal\\D0E8209F77C8CF37AD8BF550E51FF075\\MQL5\\Logs"
];

console.log('=== VERIFICANDO ÚLTIMOS LOGS DO TESTADOR ===\n');
  ...
  if (fs.existsSync(d)) {
    ...
    if (files.length > 0) {
      ...
      try {
        ...
        lines.slice(-25).forEach(l => console.log(l.trim()));
      } catch(e) {
        try {
